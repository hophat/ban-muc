...
return new class extends Migration
{
    ...
    {
        // 1. Tạo bảng users (không có farm_id ban đầu)
        ...
        // 2. Tạo bảng farms (với owner_id là nullable ban đầu)
        ...
        // 3. Thêm farm_id vào bảng users sau khi đã có bảng farms
    ...
    public function down(): void
    {
        ...
        // Xóa khóa ngoại farm_id từ users trước
        Schema::table('users', function (Blueprint $table) {
            $table->dropForeign(['farm_id']);
            $table->dropColumn('farm_id');
        });
        
        // Xóa khóa ngoại owner_id từ farms
